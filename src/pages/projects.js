...
const Projects = () => (
  ...
  <h2 className="title is-3"><a href="https://docs.microsoft.com/en-us/powershell/module/microsoft.powershell.core/about/about_modules?view=powershell-6">PowerShell Modules</a></h2>
    ...
    <div className="columns">
        ...
        <div className="column is-4">
            <article className="message is-link ">
                ...
                <div className="message-body">
                    PSSecret acts as your personal secure vault where you can <strong>encrypt, 
                    store & retrive data securely from the registry.</strong> You can store the following types of information :
                    Strings,Credentials,Hashtables,Objects.
                    <p className="projects">
                    PSSecret uses the <strong>"Crytographic Message Syntax"</strong> introduced
                     in PowerShell V5 which use the <strong>public key infrastructure PKI</strong> 
                     to encrypt data.
                     The encrypted cannot be decrypted by any other user on any other computer 
                     than the one where it was encrypted.
                    </p>
                </div>
            </article>
            <p className="buttons">
